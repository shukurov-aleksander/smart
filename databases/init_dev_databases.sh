...
CREATE SCHEMA users;
ALTER ROLE ku_users_release SET search_path TO users;
...
ALTER ROLE ku_users_app SET search_path TO users;
EOSQL
...
ALTER ROLE ku_devices_release SET search_path TO devices;
...
ALTER ROLE ku_devices_app SET search_path TO devices;
EOSQL
